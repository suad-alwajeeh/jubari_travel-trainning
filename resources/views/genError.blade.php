                          ...
                          <div class="card-body">
                            <div class="form-group row">
                              ...
                              <div class="col-md-12 m-2">
                                ...
                                <input type="hidden" class="form-control" id="gen_id" name="gen_id">
                                <input type="hidden" class="form-control" id="gen_remark_id" name="remark_id" required>
                                <input type="hidden" class="form-control" id="gen_service_id" name="service_id"
                                  required>
                                <input type="hidden" class="form-control" id="gen_emp_id" name="emp_id" required>
                                <input type="hidden" class="form-control" id="gen_number10" name="emp_id" required>
                              ...
                              <div class="col-md-12 m-2"> <input type="checkbox" name="remark[]" id="gen_number2"
                                  onclick="myFunction5()">Voucher Number : <input
                                  class="form-control col-md-6 d-inline-block m-2" type="text" id="gen_number_val"
                                  readonly>
                                <input type="text" class="form-control col-11 " style="display:none; width:100%"
                                  name="gen_number" value="null" id="gen_number3" />
                              </div>
                              <div class="col-md-12 m-2">


                                <input type="checkbox" name="remark[]" id="gen_status2" onclick="myFunction4()"> Offered
                                Status : <input class="form-control col-md-6 d-inline-block m-2" type="text"
                                  id="gen_status_val" readonly>
                                <input type="text" class="form-control col-11" style="display:none; width:100%"
                                  name="gen_status" value="null" id="gen_status" />
                              </div>
                              <div class="col-md-12 m-2"> <input type="checkbox" name="remark[]" id="gen_name2"
                                  onclick="myFunction9()">General Status : <input
                                  class="form-control col-md-6 d-inline-block m-2" type="text" id="gen_name_val"
                                  readonly>
                                <input type="text" class="form-control col-11" style="display:none; width:100%"
                                  name="gen_name" value="null" id="gen_name" />
                              </div>
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <input type="hidden" class="gen_number" value="{{$item->voucher_number}}">
                        ...
                        <input type="hidden" class="gen_status_val2" value="OK">
                        <input type="hidden" class="gen_number_val2" value="{{$item->voucher_number}}">
                       <input type="hidden" class="gen_name_val2" value="{{$item->general_status}}">
...
<script>
  ...
  function myFunction4() {
    var checkBox = document.getElementById("gen_status2");
    var text = document.getElementById("gen_status");
  ...
  function myFunction5() {
    var checkBox = document.getElementById("gen_number2");
    var text = document.getElementById("gen_number3");
  ...
  function myFunction9() {
    var checkBox = document.getElementById("gen_name2");
    var text = document.getElementById("gen_name");
  ...
  $(document).ready(function () {
    ...
    $(".add").click(function () {
      ...
      var gen_number = $(this).closest("tr").find('.gen_number').val();
      ...
      var gen_status_val2 = $(this).closest("tr").find('.gen_status_val2').val();
      var Dep_city_val2 = $(this).closest("tr").find('.Dep_city_val2').val();
      var gen_number_val2 = $(this).closest("tr").find('.gen_number_val2').val();
      var arr_city_val2 = $(this).closest("tr").find('.arr_city_val2').val();
      var dep_date_val2 = $(this).closest("tr").find('.dep_date_val2').val();
      var gen_name_val2 = $(this).closest("tr").find('.gen_name_val2').val();
      ...
      $('#gen_number').val(gen_number);
      $('#gen_number10').val(gen_number);
      $('#issue_val').val(issue_val);
      $('#passnger_name_val').val(passenger_name_val2);
      $('#refernce_val').val(refernce_val2);
      $('#gen_status_val').val(gen_status_val2);
      $('#gen_number_val').val(gen_number_val2);
      $('#gen_name_val').val(gen_name_val2);
    ...
    $("#save").click(function () {
      ...
      var emp_id = $('#gen_emp_id').val();
      var remark_id = $('#gen_remark_id').val();
      var remark_body = $('#remark_body').val();
      var service_id = $('#gen_service_id').val();
      var issue_date = $('#issue_date').val();
      var refernce = $('#refernce').val();
      var passenger_name = $('#passenger_name').val();
      var gen_status = $('#gen_status').val();
      var gen_number3 = $('#gen_number3').val();
      ...
      var remark_body = {
        ...
        'offered_status': gen_status,
        'voucher_number': gen_number3,
        'gen_name': gen_name,
      ...
      var remark_id = $('#gen_remark_id').val();
      var service_id = $('#gen_service_id').val();
      var gen_number10 = $('#gen_number10').val();
      console.log('gen_id');
      console.log(gen_id);
      $.ajax({
        url: "{{url('/displaySalesManager/saved_gen')}}",
        data: { remark_body: remark_body, gen_id: gen_id, emp_id: emp_id, remark_id: remark_id, service_id: service_id, gen_number10: gen_number10 },
