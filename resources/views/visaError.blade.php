                          ...
                          <div class="card-body">
                            <div class="form-group row">
                              ...
                              <div class="col-md-12 m-2">
                                ...
                                <input type="hidden" class="form-control" id="visa_remark_id" name="remark_id" required>
                                <input type="hidden" class="form-control" id="visa_service_id" name="service_id"
                                  required>
                                <input type="hidden" class="form-control" id="visa_emp_id" name="emp_id" required>
                              ...
                              <div class="col-md-12 m-2">
                                ...
                                <input type="checkbox" name="remark[]" id="visa_status2" onclick="myFunction4()"> visa
                                Status : <input class="form-control col-md-6 d-inline-block m-2" type="text"
                                  id="visa_status_val" readonly>
                                <input type="text" class="form-control col-11" style="display:none; width:100%"
                                  name="visa_status" value="null" id="visa_status" />
                              </div>
                              <div class="col-md-12 m-2"> <input type="checkbox" name="remark[]" id="visa_type2"
                                  onclick="myFunction19()">Visa Type : <input
                                  class="form-control col-md-6 d-inline-block m-2" type="text" id="visa_type_val"
                                  readonly>
                                <input type="text" class="form-control col-11" style="display:none; width:100%"
                                  name="visa_info" value="null" id="visa_type" />
                              </div>
                              <div class="col-md-12 m-2"> <input type="checkbox" name="remark[]" id="visa_country2"
                                  onclick="myFunction18()">Country : <input
                                  class="form-control col-md-6 d-inline-block m-2" type="text" id="visa_country_val"
                                  readonly>
                                <input type="text" class="form-control col-11" style="display:none; width:100%"
                                  name="visa_info" value="null" id="visa_country" />
                              </div>
                              <div class="col-md-12 m-2"> <input type="checkbox" name="remark[]" id="visa_info2"
                                  onclick="myFunction9()"> Info : <input
                                  class="form-control col-md-6 d-inline-block m-2" type="text" id="visa_info_val"
                                  readonly>
                                <input type="text" class="form-control col-11" style="display:none; width:100%"
                                  name="visa_info" value="null" id="visa_info" />
                              </div>
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                      ...
                      <input type="hidden" class="visa_status_val2" value="OK">
                        <input type="hidden" class="voucher_number_val2" value="{{$item->voucher_number}}">
                        <input type="hidden" class="visa_info_val2" value="{{$item->visa_info}}">
                        <input type="hidden" class="visa_country_val2" value="{{$item->country}}">
                        <input type="hidden" class="visa_type_val2" value="{{$item->visa_type}}">
...
<script>
  ...
  function myFunction4() {
    var checkBox = document.getElementById("visa_status2");
    var text = document.getElementById("visa_status");
  ...
  function myFunction9() {
    var checkBox = document.getElementById("visa_info2");
    var text = document.getElementById("visa_info");
  ...
  function myFunction18() {
    var checkBox = document.getElementById("visa_country2");
    var text = document.getElementById("visa_country");
    ...
    var checkBox = document.getElementById("visa_type2");
    var text = document.getElementById("visa_type");
  ...
  $(document).ready(function () {
    ...
    $(".add").click(function () {
      ...
      var visa_status_val2 = $(this).closest("tr").find('.visa_status_val2').val();
      var visa_type_val2 = $(this).closest("tr").find('.visa_type_val2').val();
      var visa_country_val2 = $(this).closest("tr").find('.visa_country_val2').val();
      ...
      var visa_info_val2 = $(this).closest("tr").find('.visa_info_val2').val();
      ...
      $('#visa_status_val').val(visa_status_val2);
      $('#visa_type_val').val(visa_type_val2);
      $('#visa_country_val').val(visa_country_val2);
      ...
      $('#visa_info_val').val(visa_info_val2);
    ...
    $("#save").click(function () {
      ...
      $.ajax({
        url: "{{url('/displaySalesManager/saved_visa')}}",
        data: { remark_body: remark_body, visa_id: visa_id, emp_id: emp_id, remark_id: remark_id, service_id: service_id, visa_number10: voucher_number10 },
