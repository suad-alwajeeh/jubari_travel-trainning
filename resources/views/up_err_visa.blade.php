...
<div class="col-12">
            <ol class="breadcrumb float-sm-right bg-white">
              <li class="breadcrumb-item"><a href="/salesVisaLog">Visa Services</a></li>
              <li class="breadcrumb-item active"> /Update Visa Services</li>
            </ol>
  </div>
  </br>
  </br>
<div class="content-wrapper">
    <div class="container p-4">
        ...
        <div class="card card-outline card-info">
            ...
            <form method="POST" action="/service/updateVisa2" enctype="multipart/form-data" id="signup-form">
          @csrf
                     ...
                     { echo'  <div class="form-row col-md-12 col-sm-12 col-xm-12">
                      <div class="form-group col-md-6 col-sm-12 col-xm-12">
                          ...
                          <div class="form-group ">
                             ';
                            ?>
            <input type="hidden" value="{{$bus->visa_id}}" name="id">
...
?>
  ...
  <input type="hidden"  name="visa_status" value="1">';
  elseif ( $bus->visa_status==2)
  echo '<option value="2" selected disbled>Issue</option>
  <input type="hidden" name="visa_status" value="2">  ';
  elseif ( $bus->visa_status==3)
  echo'<option value="3" disabled  selected>Void</option> 
  <input type="hidden" name="visa_status" value="3">';
  else
  echo '  <option value="4"  disabled selected>Refund</option>
  <input type="hidden" name="visa_status" value="4">
  ';
...
';
  ?>
               <input required type="text" class="form-control " style="width:100%;" 
                                        value="{{$bus->country}}" name="country" /> 
...
';
  ?>
             <input required disabled type="text" class="form-control " style="width:100%;" 
                                        value="{{$bus->country}}" />
                                         <input required name="country" style="width:100%" onkeyup="addHyphen(this)" id="tbNum" type="hidden"
      ...
      ?>
               <input required type="text" class="form-control " style="width:100%;"
                                        name="visa_type" value="{{$bus->visa_type}}" />
...
<?php echo'   </div>
               ...
               else
               {
                  ...
                  <div class="form-group" data-select2-id="44">';
      ?>
             <input required type="text"  disabled class="form-control " style="width:100%;"
                                         value="{{$bus->visa_type}}" />
  <input required name="visa_type" type="hidden" class="form-control " style="width:100%;"
                                         value="{{$bus->visa_type}}" />
              <?php echo'   </div>
                  </div>';
                 }
             ...
             if($visa_info)
             {
                 ...
                 ?>
                     ...
                     <input type="text" class="form-control " value="{{$bus->visa_info}}" required name="visa_info" />
             ...
             <?php echo'  </div>
                ...
                ?>
                    ...
                    <input type="text" class="form-control " disabled value="{{$bus->visa_info}}"required  />
                    <input type="hidden" class="form-control " name="visa_info"  value="{{$bus->visa_info}}"required  />
              <?php echo'  </div>
            </div>
        </div>
    </div>';
  ...
  ';
        ...
        ?>
              ...
              @endforeach
            <div class="form-group">
                <a href="{{url('salesVisaLog')}}" class="btn btn-outline-danger so_form_btn">Cancel</a>
