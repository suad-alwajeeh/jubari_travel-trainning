            ...
            <div class="around">
              ...
              <div class="form-row col-md-12 col-sm-12 col-xm-12">
                ...
                <div class="form-group col-md-3 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group">
                    <input type="number"  required class="form-control" name="voucher_number" id="number" />
              ...
              <div class="form-row col-md-12 col-sm-12 col-xm-12">
                ...
                <div class="form-group col-md-4 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group"    >
                    ...
                    <input required name="Dep_city" style="width:100%" onkeyup="addHyphen(this)" id="tbNum9" type="text"
