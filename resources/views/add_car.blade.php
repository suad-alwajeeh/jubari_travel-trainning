...
<div class="col-12">
            <ol class="breadcrumb float-sm-right bg-white">
              ...
              <li class="breadcrumb-item active">Add Car Services</li>
            </ol>
  </div>
  </br>
  </br>
    ...
    <div class="container p-4">
        ...
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                ...
                <form method="POST" id="signup-form" action="add_car" enctype="multipart/form-data">
                    @csrf
                    <div class="around">
                            ...
                            <div class="form-group col-md-3 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select2-hidden-accessible" name="car_status"
                                        id="code" style="width: 100%;" data-select2-id="6" tabindex="0"
                                        aria-hidden="true">
                        ...
                        <div class="form-row col-md-12 col-sm-12 col-xm-12">
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required name="Dep_city" style="width:100%" onkeyup="addHyphen(this)"
                                        id="tbNum9" type="text" class="form-control     " list="cars" />
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" style="width:100%" name="arr_city"
                                        onkeyup="addHyphen(this)" id="tbNum10" class="form-control     " list="cars" />
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control " required name="car_info" />
                                </div>
                            </div>
                        </div>
                    </div>
