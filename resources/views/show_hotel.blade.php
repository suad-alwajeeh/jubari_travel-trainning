...
<div class="content-wrapper">
          ...
          <div class="card">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-outline-primary so_form_btn" href="/service/hotel"> <i class="fa fa-plus" aria-hidden="true"></i> Add New Service</a>
                    ...
                    <tbody class="row2">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a class="m-2" 
                            href="{{ url('/service/update_hotel/'.$hotels->hotel_id) }}"><i class="fa fa-pencil-alt text-primary"
                              aria-hidden="true"></i></a>
  ...
  <tfoot>
                      <tr>
                        <button formaction="/deleteallhotel" type="submit"
                          class="btn btn-danger   float-left p-2 m-3">Delete All Selected</button>
                        <button formaction="/sendallhotel" type="submit" class="btn  btncolor float-right p-2 m-3 ">Send
                          All Selected</button>
