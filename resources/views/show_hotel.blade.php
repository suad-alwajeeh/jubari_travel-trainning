                    ...
                    <div class="card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-outline-primary so_form_btn" href="/service/hotel"> <i
                                        ...
                                        <tbody class="row2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="m-2"
                                                        href="{{ url('/service/update_hotel/'.$hotels->hotel_id) }}"><i
                                        ...
                                        <tfoot>
                                            <tr>
                                                <button formaction="/deleteallhotel" type="submit"
                                                    ...
                                                    Selected</button>
                                                <button formaction="/sendallhotel" type="submit"
                                                    class="btn  btncolor float-right p-2 m-3 ">Send
                                                    All Selected</button>
