...
name="Issue_date" value="{{ \Carbon\Carbon::createFromDate($bus->Issue_date)->format('Y-m-d')}}" />
                    </div>
                  </div>
                  <div class="form-group col-md-6 col-sm-12 col-xm-12">
                ...
                <div class="form-group clo-12">
                  ...
                  <div class="form-group" >
                    ...
                    <input required type="text" class="form-control select2 select2-hidden-accessible"
                      name="passenger_name" value="{{$bus->passenger_name}}" class="form-control select2 select2-hidden-accessible"
                      style="width: 100%;" />
                  </div>
                </div>
                ...
                <div class="form-group col-md-4 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group">
                      ...
                      <input required type="text" class="form-control "
                        style="width:100%;" name="bus_name" value="{{$bus->bus_name}}" />
                ...
                <div class="form-row col-md-12 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group col-md-4 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <input required name="Dep_city1" style="width:100%" onkeyup="addHyphen(this)" id="tbNum"
                        type="text" value="{{$bus->Dep_city}}" class="form-control " list="cars" />
                  ...
                  <div class="form-group col-md-4 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      <input required type="date" style="width:100%" value="{{ \Carbon\Carbon::createFromDate($bus->Dep_date)->format('Y-m-d')}}""
                  ...
                  <div class="form-group col-md-4 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <input required type="text" style="width:100%" name="arr_city" onkeyup="addHyphen(this)"
                        id="tbNum2" class="form-control " value="{{$bus->arr_city}}" list="cars" />
                  ...
                  <div class="form-group col-md-12 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <select name="passnger_currency" class="form-control "
                        ...
                        <option value="{{$bus->passnger_currency}}" selected>{{$bus->passnger_currency}}</option>
              ...
              <div class="around">
                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group" data-select2-id="44">
                    ...
                    <textarea id="form7" class="md-textarea form-control" name="remark" rows="3">{{$bus->remark}}</textarea>
                  </div>
                </div>
              </div>
              <div class="form-group col-md-12 col-sm-12 col-xm-12">
