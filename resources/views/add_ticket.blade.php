...
<div class="col-12">
            <ol class="breadcrumb float-sm-right bg-white">
              ...
              <li class="breadcrumb-item active">Add Ticket Services</li>
            </ol>
  </div>
  </br>
  </br>
                    ...
                    <div class="around">
                        ...
                        <div class="form-row col-md-12 col-sm-12 col-xm-12">
                            ...
                            <div class="form-group col-6" data-select2-id="44">
                                ...
                                <input required type="text" class="form-control select2 select2-hidden-accessible"
                                    name="passenger_name" style="width: 100%;" />
                            </div>
                        ...
                        <div class="form-row col-md-12 col-sm-12 col-xm-12">
                            ...
                            <div class="form-group col-md-3 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group" data-select2-id="44">
                                    <select id="airline" name="airline"
                                        ...
                                        data-select2-id="3" tabindex="0" aria-hidden="true">
                            ...
                            <div class="form-group col-md-3 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required class="form-control " style="width: 100%;" name="ticket_number"
                                        id="number" />
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group" data-select2-id="44">
                                    ...
                                    <input required name="Dep_city1" style="width:100%" onkeyup="addHyphen(this)"
                                        id="tbNum" type="text" class="form-control " list="cars" />
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" style="width:100%" name="arr_city"
                                        onkeyup="addHyphen(this)" id="tbNum2" class="form-control " list="cars" />
                        ...
                        <div style="display:none;" class="otherAnswer">
                            <div class="form-row col-md-12 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                    <label class="col-md-12 col-sm-12 col-xm-12">Dep City2 </label>
                                    <div class="form-group">


                                        <input type="text" name="Dep_city2" style="width:100%" onkeyup="addHyphen(this)"
                                            id="tbNum3" class="form-control " list="cars" />

                                    </div>
                                </div>

                                <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                    <label class="col-md-12 col-sm-12 col-xm-12">Dep Date2 </label>
                                    <div class="form-group">
                                        <input type="date" name="dep_date2" style="width:100%" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                    <label class="col-md-12 col-sm-12 col-xm-12">Arr City2 </label>
                                    <div class="form-group">

                                        <input type="text" name="arr_city2" style="width:100%" onkeyup="addHyphen(this)"
                                            id="tbNum4" class="form-control " list="cars" />
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                <div class="form-group">
                                    ...
                                    <div id="text" class="form-group">
                                        <input type="date" class="form-control " style="display:none; width:100%"
                                            name="bursher_time" id="ddate" />
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="passnger_currency"
                                        class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                                        data-select2-id="2" tabindex="0" aria-hidden="true">
...
<script>
    ...
    function myFunction() {
        ...
        // Get the output text
        var text = document.getElementById("ddate");
