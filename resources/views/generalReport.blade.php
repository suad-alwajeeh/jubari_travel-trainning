...
@section('main_content')
  ...
  <h2 class="card-title">General Service Report</h2>
    </div>
<div class="card-body">
<div class="row">
  <div class="col-md-2">
    <div class="dropdown so_form_btn">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="/generalReport">all</a>
        <a class="dropdown-item " href="/generalReport/19"> USD</a>
        <a class="dropdown-item " href="/generalReport/20">YER</a>
        <a class="dropdown-item " href="/generalReport/21">SAR</a>
      </div>
  ...
  <div class="col-md-2">
    <div class="dropdown so_form_btn">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="/generalReport">all</a>
        @foreach($all as $supp)
        <a class="dropdown-item" href="/generalReport/a/{{$supp->s_no}}">{{$supp->supplier_name}}</a>
        @endforeach
      </div>
  ...
  <div class="col-md-2">
    <div class="dropdown so_form_btn">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="/generalReport">all</a>
        @foreach($all as $supp)
        <a class="dropdown-item" href="/generalReport/b/{{$supp->emp_id}}">{{$supp->emp_first_name}} {{$supp->emp_last_name}}</a>
        @endforeach
      </div>
...
<div class="container" id="pdf">  
  ...
  <table class="table table-hover text-center">
    ...
    <tbody>
      ...
      <tr>
        <input type="hidden" class="delete_id" value="{{$item->gen_id}}">
        <td><?php echo $i;?></td>
