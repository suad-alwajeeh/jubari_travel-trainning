...
<div class="content-wrapper">
    <div class="container p-4">
        ...
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                <form method="POST" id="signup-form" action="/service/updateHotel" class="signup-form"
                            ...
                            <div class="form-group col-md-6 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input required type="date" class="form-control     " name="Issue_date" id="date"
                                        value="{{ \Carbon\Carbon::createFromDate($hotel->Issue_date)->format('Y-m-d')}}" />
                                </div>
                            </div>
                            <div class="form-group col-md-6 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control select2 select2-hidden-accessible"
                                        value="{{$hotel->refernce}}" name="refernce">
                                </div>
                            </div>
                        </div>
                        <div class="form-row col-md-12 col-sm-12 col-xm-12">
                            <div class="form-group col-md-6 col-sm-12 col-xm-12">
                                ...
                                <input required type="text" class="form-control  " name="passenger_name"
                                    class="form-control " style="width: 100%;" value="{{$hotel->passenger_name}}" />
                            </div>

                            <div class="form-group col-md-3 col-sm-12 col-xm-12">
                                <label class="col-md-12 col-sm-12 col-xm-12">Voucher Number :</label>
                                <div class="form-group">
                                    <input type="number" class="form-control " value="{{$hotel->voucher_number}}"
                                        name="voucher_number" id="number" />
                            ...
                            <div class="form-group col-md-2 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    <input required type="date" style="width:100%" class="form-control" name="check_in"
                                        id="date2"
                                        value="{{ \Carbon\Carbon::createFromDate($hotel->check_in)->format('Y-m-d')}}" />
                                </div>
                            </div>
                            <div class="form-group col-md-2 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    <input required type="date" style="width:100%" class="form-control"
                                        value="{{ \Carbon\Carbon::createFromDate($hotel->check_out)->format('Y-m-d')}}"
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group" data-select2-id="44">
                                    <select name="due_to_supp" required
                                        ...
                                        <option value="{{$hotel->s_no}}" selected>{{$hotel->supplier_name}}</option>
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="passnger_currency"
                                        ...
                                        <option value="{{$hotel->passnger_currency}}" selected>
                                            {{$hotel->passnger_currency}}</option>
        ...
        <div class="form-group">
            <a href="{{url('service/show_hotel/1')}}" class="btn btn-outline-danger so_form_btn">Cancel</a>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#generate').click(function (e) {
            ...
            $.ajax({
                url: "{{url('/service/generate_hotel')}}",
