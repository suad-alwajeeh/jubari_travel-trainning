...
@foreach($data as $item)
    <div class="form-group col-md-4 col-sm-12">
      ...
      <input type="text" value="{{$item->cus_name}}" required  class="form-control" id="cus_name"  name="cus_name">
 ...
 <div class="form-group col-md-4 col-sm-12">
      ...
      <input type="text" value="{{$item->contact_person}}" required  class="form-control" id="contact_person"  name="contact_person">
      <small id="helpId2" class="text-muted"></small>
</div>
<div class="form-group col-md-4 col-sm-12">
      <label for="pwd">contact title:</label>
      <input type="text" value="{{$item->contact_title}}" required class="form-control" id="contact_title" name="contact_title">
      <small id="helpId3" class="text-muted"></small>
 </div>
 <div class="form-group col-md-2 col-sm-12">
      <label for="pwd">account number:</label>
      <input type="number" value="{{$item->cus_account}}" required class="form-control" id="cus_account" name="cus_account">
      <small id="helpId4" class="text-muted"></small>
 </div>
 <div class="form-group col-md-2 col-sm-12">
      <label for="pwd">telephon 1:</label>
      <input type="number" value="{{$item->telephon1}}"  class="form-control" id="telephon1"  name="telephon1">
      <small id="helpId5" class="text-muted"></small>
</div>
<div class="form-group col-md-2 col-sm-12">
      <label for="pwd">telephon_2</label>
      <input type="text" value="{{$item->telephon2}}" required class="form-control" id="telephon2"  name="telephon2">
      <small id="helpId6" class="text-muted"></small>
</div>
<div class="form-group col-md-2 col-sm-12">
      <label for="pwd">fax_1</label>
      <input type="text" value="{{$item->fax1}}" required class="form-control" id="fax1" name="fax1">
      <small id="helpId7" class="text-muted"></small>
</div>
<div class="form-group col-md-2 col-sm-12">
      <label for="pwd">fax_2</label>
      <input type="text" value="{{$item->fax2}}" required class="form-control" id="fax2" name="fax2">
      <small id="helpId8" class="text-muted"></small>
 </div>
 <div class="form-group col-md-2 col-sm-12">
      <label for="pwd">	whatsapp</label>
      <input type="text" value="{{$item->whatsapp}}" required class="form-control" id="whatsapp"  name="whatsapp">
      <small id="helpId9" class="text-muted"></small>
</div>
<div class="form-group col-md-3 col-sm-12">
      <label for="pwd">email</label>
      <input type="text" value="{{$item->cus_email}}" required  class="form-control" id="cus_email"  name="cus_email">
...
<div class="form-group col-md-3 col-sm-12">
      ...
      <input type="text" value="{{$item->city}}" required  class="form-control" id="city"  name="city">
      <small id="helpId12" class="text-muted"></small>
</div>
<div class="form-group col-md-3 col-sm-12">
      <label for="pwd">country</label>
      <input type="text" required value="{{$item->country}}"  class="form-control" id="country" name="country">
...
<div class="form-group col-md-3 col-sm-12">
   ...
   <input type="text" hidden="hidden" value="{{$item->cus_id}}" class="form-control" id="cus_id" placeholder="cus_id" name="id">
@endforeach
   </form> 
</div>
      ...
      if (cus_name != "" && cus_account != "" && address != "" && country != "" && cus_email != "" && whatsapp != "" && city != "" && contact_person != "" && contact_title != "" && telephon1 != "" && telephon2 != "" && fax1 != "" && fax2 != ""){
         $.ajax({
             ...
             success:function(response){console.log(response);
              window.location.href = "/customer_display1/2";
                 },
