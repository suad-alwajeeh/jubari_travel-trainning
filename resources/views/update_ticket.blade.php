...
name="Issue_date" value="{{ \Carbon\Carbon::createFromDate($ticket->Issue_date)->format('Y-m-d')}}" />
                  ...
                  <div class="form-group col-md-6 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <input required type="text" class="form-control" value="{{$ticket->refernce}}" name="refernce">
                    </div>
                  </div>
                </div>
                <div class="form-row col-md-12 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group col-md-3 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <input required type="text" class="form-control "
                        style="width:100%;" name="ticket_number" value="{{$ticket->ticket_number}}"  id="number"/>
                  ...
                  <div class="form-group col-md-4 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <input required name="Dep_city1" style="width:100%" onkeyup="addHyphen(this)" id="tbNum"
                        type="text" value="{{$ticket->Dep_city}}" class="form-control " list="cars" />
                  ...
                  <div class="form-group col-md-4 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <input required type="text" style="width:100%" name="arr_city" onkeyup="addHyphen(this)"
                        id="tbNum2" class="form-control " value="{{$ticket->arr_city}}" list="cars" />
                    ...
                    <div class="form-group col-md-4 col-sm-12 col-xm-12">
                      ...
                      <div class="form-group" data-select2-id="44">
                        ...
                        <input type="text" name="dep_city1" style="width:100%" onkeyup="addHyphen(this)" id="tbNum3"
                          class="form-control "value="{{$ticket->Dep_city2}}" list="cars" />
                    ...
                    <div class="form-group col-md-4 col-sm-12 col-xm-12">
                      ...
                      <div class="form-group" data-select2-id="44">
                        ...
                        <input type="text" name="arr_city1" style="width:100%" onkeyup="addHyphen(this)" id="tbNum4"
                          class="form-control "value="{{$ticket->arr_city2}}" list="cars" />
...
@if($ticket->bursher_time!=null)
 ...
 value="{{\Carbon\Carbon::createFromDate($ticket->bursher_time)->format('Y-m-d')}}" name="bursher_time"   name="bursher_time"  />
                      </div>
                    </div>
                  ...
                  <div class="form-group col-md-12 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      <select  name="due_to_supp" required
                        ...
                        <option value="{{$ticket->s_no}}" selected>{{$ticket->supplier_name}}</option>
