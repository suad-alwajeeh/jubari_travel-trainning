...
<div class="col-12">
            <ol class="breadcrumb float-sm-right bg-white">
              <li class="breadcrumb-item"><a href="salesTicketLog">Ticket Services</a></li>
...
else
{
    ...
    <div class="form-group" data-select2-id="44">
        <select class="form-control select2 select2-hidden-accessible"
            name="" id="code" style="width: 100%;" data-select2-id="3"
            tabindex="0" aria-hidden="true">
...
<input type="hidden" name="ticket_status" value="4">
';
