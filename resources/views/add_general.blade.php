    ...
    <div class="container p-4">
        ...
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                ...
                <form method="POST" id="signup-form" action="add_service" enctype="multipart/form-data">
                    @csrf
                    <div class="around">
                        ...
                        <div class="form-row col-md-12 col-sm-12 col-xm-12">
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    <input type="number" required class="form-control" name="voucher_number"
                                        id="number" />
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select2-hidden-accessible" name="general_status"
                                        id="code" style="width: 100%;" data-select2-id="7" tabindex="0"
                                        aria-hidden="true">
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                <label class="col-md-12 col-sm-12 col-xm-12">Offered Service</label>
                                <div class="form-group">
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" required name="med_info">
                                </div>
                            </div>
                            ...
                            <div class="form-row col-md-12 col-sm-12 col-xm-12">
                                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div id="text" class="form-group">
                                        <input type="date" class="form-control col-md-4 col-sm-10 col-xm-10 "
                                            style="display:none; width:100%" name="busher_time" id="ddate" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="passnger_currency"
                                            class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                                            data-select2-id="8" tabindex="0" aria-hidden="true">
