...
<div class="col-6">
            <ol class="breadcrumb float-sm-right bg-white">
              ...
              <li class="breadcrumb-item active"> Medical Services</li>
                    ...
                    <div class="card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-outline-primary so_form_btn" href="/service/medical"> <i
                                    ...
                                    <form method="post">
                                        ...
                                        <tbody class="row2">
                                            ...
                                            <tr>
                                                ...
                                                @if($meds->ses_status==1)
                                                <td>OK</td>
                                                @elseif($meds->ses_status==2)
                                                <td>Issue</td>
                                                @elseif($meds->ses_status==3)
                                                <td>Void</td>
                                                @elseif($meds->ses_status==4)
                                                <td>Refund</td>
                                                @endif
                                                <td>{{$meds->med_info }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="m-2"
                                                        href="{{ url('/service/update_med/'.$meds->med_id) }}"><i
                                        ...
                                        <tfoot>
                                            ...
                                            @endforelse
                                            <tr>
                                                <button formaction="/deleteallmed" type="submit"
                                                    class="btn btn-danger float-left m-3 p-2">Delete All
                                                    Selected</button>
                                                <button formaction="/sendallmed" type="submit"
                                                    class="btn btncolor float-right m-3 p-2">Send All
                                                    Selected</button>
                                            </tr>
                                        </tfoot>
                                </table>
