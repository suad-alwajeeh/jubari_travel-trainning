  ...
  <section class="content">
          ...
          <div class="card">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-outline-primary so_form_btn" href="/service/med"> <i class="fa fa-plus" aria-hidden="true"></i> Add New Service</a>
                    ...
                    <tbody class="row2">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a class="m-2" 
                            href="{{ url('/service/update_med/'.$meds->med_id) }}"><i class="fa fa-pencil-alt text-primary"
                              aria-hidden="true"></i></a>
   ...
   <tr>
                       <button formaction="/deleteallmed" type="submit"
                          class="btn btn-danger float-left m-3 p-2">Delete All Selected</button>
                        <button formaction="/sendallmed" type="submit" class="btn btncolor float-right m-3 p-2">Send All
                          Selected</button>
                      </tr>
                    </tfoot>
                </table>
