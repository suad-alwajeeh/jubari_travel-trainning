      ...
      <div class="card card-primary card-outline card-outline-tabs">
        <div class="card-header p-0 border-bottom-0">
          <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/salesGenLog" role="tab">Car</a>
            </li>
            <li class="nav-item">
...
@if($val=='null')
 <td> {{ $item->gen_info}}</td>
 @else
 <td class="text-red"> {{ $item->gen_info}}</td>
 @endif
 @endif   
 ...
 @if($model=='due_to_supp')
  ...
  @endforeach
                        ...
                        <td>
                            ...
                            href="{{ url('/sales/update_gen/'.$item->gen_id) }}"><i class="fa fa-pencil-alt"
