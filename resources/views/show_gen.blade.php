...
<tr> <td colspan="10" >There is No data  Pleas Add Service <td></tr>
                  ...
                  <tfoot>
<tr>
<button  formaction="/deleteallgen" type="submit" class="btn btn-danger  float-left p-2 m-3">Delete All Selected</button>
	<button formaction="/sendallgen" type="submit" class="btn btncolor float-right p-2 m-3">Send All Selected</button>
</tr></tfoot> 
                </table>
