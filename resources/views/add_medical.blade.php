  ...
  <div class="container p-4">
    ...
    <div class="card card-outline card-info">
      ...
      <div class="card-body">
          ...
          <form method="POST" id="signup-form" action="add_medical" enctype="multipart/form-data" >
          @csrf
            <div class="around">
              ...
              <div class="form-row col-md-12 col-sm-12 col-xm-12">
                ...
                <div class="form-group col-md-4 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group"     >
                    ...
                    <input type="number" class="form-control" name="document_number"  required id="number" />
                ...
                <div class="form-group col-md-4 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group"     >
                    ...
                    <input type="text"required  name="from_city"class="form-control     " list="cars" />
                  </div>
                </div>
              </div>
              <div class="form-row col-md-12 col-sm-12 col-xm-12">
