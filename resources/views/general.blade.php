              ...
              <div class="card-body table-responsive p-0">
                <table id="datatable" class="table table-hover text-nowrap text-center">
                 ...
                 @foreach($gens as $general)
                  <tr>
                  <input type="hidden"  class="delete_id"value="{{$general->gen_id}}">
                  <td>{{$general->id}}</td>
                    <td>{{$general->Issue_date }}</td>
                    <td> {{$general->refernce}} </td>
                    <td>{{$general->passenger_name}}</td>
                    <td>{{$general->voucher_number}} </td>
                    <td>{{$general->offered_status}}</td>
                    <td>{{$general->gen_info}}</td>
                    <td>{{$general->Dep_city}} </td>
                    <td> {{$general->dep_date}} </td>
                    <td> {{$general->arr_city}} </td>
                    <td>{{$general->sup_name}} </td>
                    <td>{{$general->provider_cost}} </td>
                    <td>{{$general->cur_name}}</td>
                    <td>{{$general->cost}}  </td>
                    <td> {{$general->passnger_currency}} </td>
