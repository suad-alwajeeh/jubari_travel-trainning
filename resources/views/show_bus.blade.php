...
<div class="col-6">
            <ol class="breadcrumb float-sm-right bg-white">
              ...
              <li class="breadcrumb-item active"> Bus Services</li>
                    ...
                    <div class="card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-outline-primary so_form_btn" href="/service/bus"> <i
                                    ...
                                    <form method="post">
                                        ...
                                        <tbody class="row2">
                                            ...
                                            <tr>
                                                ...
                                                @if($buss->ses_status==1)
                                                <td>OK</td>
                                                @elseif($buss->ses_status==2)
                                                <td>Issue</td>
                                                @elseif($buss->ses_status==3)
                                                <td>Void</td>
                                                @elseif($buss->ses_status==4)
                                                <td>Refund</td>
                                                @endif
                                                <td>{{$buss->Dep_city}} </td>
                                                <td> {{$buss->dep_date}} </td>
                                                <td> {{$buss->arr_city}} </td>
                                                <td>{{$buss->supplier_name}} </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="m-2"
                                                        href="{{ url('/service/update_bus/'.$buss->bus_id) }}"><i
                                        ...
                                        <tr>
                                            ...
                                            <button formaction="/sendallbus" type="submit"
