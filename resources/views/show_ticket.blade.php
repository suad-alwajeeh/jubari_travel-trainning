...
<div class="content-wrapper">
                  ...
                  <form method="post">
                    ...
                    <tbody class="row2">
                      ...
                      <tr>
                        ...
                        <td><input type="checkbox" name="ids[]" class="selectbox" value="{{$tickets->tecket_id }}"></td>
 ...
 <tfoot>
                        ...
                        <tr >
                        <button formaction="/deleteallticket" type="submit" class="fixed btn btn-danger   float-left m-3 p-2">Delete All Selected</button>
                        <button formaction="/sendallticket" type="submit" class=" fixed btn  btncolor float-right m-3 p-2">Send
                          All Selected</button>
                          </tr>
