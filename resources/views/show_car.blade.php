...
<div class="content-wrapper">
                ...
                <table id="datatable" class="table table-responsive table-hover text-nowrap text-center">
                  ...
                  <form method="post">
                    ...
                    <tbody class="row2">
                      ...
                      @forelse($car as $cars)
                      <tr>
                        <td><input type="checkbox" name="ids[]" class="selectbox" value="{{$cars->car_id }}"></td>
                        ...
                        <td>
                          ...
                          <a  class="m-2"><i class="fa fa-paper-plane text-info"
                              aria-hidden="true"></i></a>
                          <a class="m-2" type="button"
                            href="{{ url('/service/update_car/'.$cars->car_id) }}"><i class="fa fa-pencil-alt text-primary"
                              aria-hidden="true"></i></a>
 ...
 <tfoot>
                      <tr>
                        ...
                        <button formaction="/sendallcar" type="submit" class="btn btncolor float-right p-2 m-3">Send All
                          Selected</button>
                      </tr>
                    </tfoot>
                </table>
