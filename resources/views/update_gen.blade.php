...
<form method="POST" action="/service/updateGen" enctype="multipart/form-data" id="signup-form" class="signup-form">
              @csrf
...
name="Issue_date" value="{{ \Carbon\Carbon::createFromDate($gen->Issue_date)->format('Y-m-d')}}" />
                    </div>
                  </div>
                  <div class="form-group col-md-6 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" >
                      ...
                      <input required type="text" class="form-control" value="{{$gen->refernce}}" name="refernce">
                    </div>
                  </div>
                </div>
                <div class="form-group clo-12">
                  ...
                  <div class="form-group" >
                    ...
                    <input required type="text" class="form-control select2 select2-hidden-accessible"
                      name="passenger_name" value="{{$gen->passenger_name}}" class="form-control select2 select2-hidden-accessible"
                      style="width: 100%;" />
                  </div>
                </div>
                  ...
                  <div class="form-group col-md-4 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <input required type="number" class="form-control "
                        style="width:100%;" name="voucher_number" value="{{$gen->voucher_number}}"  id="number"  />
                ...
                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <input required type="text" class="form-control "
                        style="width:100%;" name="gen_info" value="{{$gen->gen_info}}" />
                    </div>
                  </div>
                </div<
                @endforeach
                  ...
                  <div class="form-group col-md-12 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <select name="passnger_currency" class="form-control "
                        ...
                        <option value="{{$gen->passnger_currency}}" selected>{{$gen->passnger_currency}}</option>
              ...
              <div class="around">
                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group" data-select2-id="44">
                    ...
                    <textarea id="form7" class="md-textarea form-control" name="remark" rows="3">{{$gen->remark}}</textarea>
                  </div>
                </div>
              </div>
              <div class="form-group col-md-12 col-sm-12 col-xm-12">
