...
<div class="col-12">
            <ol class="breadcrumb float-sm-right bg-white">
              ...
              <li class="breadcrumb-item active">Update General Services</li>
            </ol>
  </div>
  </br>
  </br>
    ...
    <div class="container p-4">
        ...
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="/service/updateGen" enctype="multipart/form-data" id="signup-form"
                    class="signup-form">
                    @csrf
                        ...
                        <div class="form-row col-md-12 col-sm-12 col-xm-12">
                            <div class="form-group col-md-6 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group ">
                                    <input type="hidden" value="{{$gen->gen_id}}" name="id">
                            ...
                            <div class="form-group col-md-6 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" value="{{$gen->refernce}}"
                                        name="refernce">
                                </div>
                            </div>
                        </div>
                        <div class="form-group clo-12">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control select2 select2-hidden-accessible"
                                    name="passenger_name" value="{{$gen->passenger_name}}"
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group" data-select2-id="44">
                                    ...
                                    <input required type="number" class="form-control " style="width:100%;"
                                        name="voucher_number" value="{{$gen->voucher_number}}" id="number" />
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="form-group" data-select2-id="44">
                                        <select name="due_to_supp" required
                                            ...
                                            <option value="{{$gen->s_no}}" selected>{{$gen->supplier_name}}</option>
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="cur_id" required
                                            ...
                                            <option value="{{$gen->cur_id}}" selected> {{$gen->cur_name}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="form-group" data-select2-id="44">
                                        ...
                                        <select name="due_to_customer"
                                            ...
                                            @foreach($emp as $emps)
                                            @if($gen->due_to_customer==$emps->emp_id)
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="form-group" data-select2-id="44">
                                        ...
                                        <select name="passnger_currency" class="form-control " style="width: 100%;"
                                            ...
                                            <option value="{{$gen->passnger_currency}}" selected>
                                                {{$gen->passnger_currency}}</option>
            ...
            <div class="form-group">
                <a href="{{url('service/show_general/1')}}" class="btn btn-outline-danger so_form_btn">Cancel</a>
