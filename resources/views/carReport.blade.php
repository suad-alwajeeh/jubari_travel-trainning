...
@section('main_content')
  ...
  <h2 class="card-title">Car Service Report</h2>
</div>
<div class="card-body">
<div class="row">
  <div class="col-md-2">
    <div class="dropdown so_form_btn">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="/carReport">all</a>
      <a class="dropdown-item " href="/carReport/10"> USD</a>
      <a class="dropdown-item " href="/carReport/11">YER</a>
      <a class="dropdown-item " href="/carReport/12">SAR</a>
      </div>
  ...
  <div class="col-md-2">
    <div class="dropdown so_form_btn">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="/carReport">all</a>
        @foreach($all as $supp)
        <a class="dropdown-item" href="/carReport/a/{{$supp->s_no}}">{{$supp->supplier_name}}</a>
        @endforeach
      </div>
  ...
  <div class="col-md-2">
    <div class="dropdown so_form_btn">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="/carReport">all</a>
        @foreach($all as $supp)
        <a class="dropdown-item" href="/carReport/b/{{$supp->emp_id}}">{{$supp->emp_first_name}} {{$supp->emp_last_name}}</a>
        @endforeach
      </div>
...
<div class="container" id="pdf">  
  ...
  <table class="table table-hover text-center">
    ...
    <tbody>
      ...
      <tr>
        <input type="hidden" class="delete_id" value="{{$item->car_id}}">
        <td><?php echo $i;?></td>
