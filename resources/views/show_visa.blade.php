...
<tr> <td colspan="10" >There is No data  Pleas Add Service <td></tr>
                  ...
                  <tfoot>
                      <tr>
  <button  formaction="/deleteallvisa" type="submit" class="btn btn-danger  float-left m-3 p-2">Delete All Selected</button>
	<button formaction="/sendallvisa" type="submit" class="btn btncolor float-right m-3 p-2">Send All Selected</button>     
</tr>
</tfoot>              
                </table>
