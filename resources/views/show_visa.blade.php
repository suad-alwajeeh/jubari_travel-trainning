...
<div class="col-6">
            <ol class="breadcrumb float-sm-right bg-white">
              ...
              <li class="breadcrumb-item active"> Visa Services</li>
                    ...
                    <div class="card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-outline-primary so_form_btn" href="/service/visa"> <i
                                    ...
                                    <form method="post">
                                        ...
                                        <tbody class="row2">
                                            ...
                                            <tr>
                                                ...
                                                @if($visas->ses_status==1)
                                                <td>OK</td>
                                                @elseif($visas->ses_status==2)
                                                <td>Issue</td>
                                                @elseif($visas->ses_status==3)
                                                <td>Void</td>
                                                @elseif($visas->ses_status==4)
                                                <td>Refund</td>
                                                @endif
                                                <td>{{$visas->country }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="m-2"
                                                        href="{{ url('/service/update_visa/'.$visas->visa_id) }}"><i
                                        ...
                                        <tfoot>
                                            <tr>
                                                <button formaction="/deleteallvisa" type="submit"
                                                    class="btn btn-danger  float-left m-3 p-2">Delete All
                                                    Selected</button>
                                                <button formaction="/sendallvisa" type="submit"
                                                    class="btn btncolor float-right m-3 p-2">Send All Selected</button>
                                            </tr>
                                        </tfoot>
                                </table>
