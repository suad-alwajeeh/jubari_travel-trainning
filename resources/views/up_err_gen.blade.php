...
<div class="col-12">
  <ol class="breadcrumb float-sm-right bg-white">
    <li class="breadcrumb-bus"><a href="/salesGenLog">General Services</a></li>
    <li class="breadcrumb-bus active"> /Update General Services</li>
  </ol>
</div>
</br>
</br>
  ...
  <div class="container p-4">
    ...
    <div class="card card-outline card-info">
      ...
      <div class="card-body">
        ...
        <form method="POST" action="/service/updateGen2" enctype="multipart/form-data" id="signup-form">
          @csrf
...
?>
            ...
            <?php echo ' <small id="helpId2" class="text-muted "></small>
               ...
               if ($general_status) {
                   ...
                   <label class="col-md-12 col-sm-12 col-xm-12">Service Status :</label>
                   <div class="form-group">
                                    <select class="form-control select2 select2-hidden-accessible" name="general_status"
                                        id="code" style="width: 100%;" data-select2-id="1" tabindex="0"
                                        aria-hidden="true">';
                           if( $bus->general_status==1)
                           echo '  <option value="1" selected>OK</option>
                           <option value="2">Issue</option>
                           <option value="3">Void</option>
                           <option value="4">Refund</option>';
                           elseif ( $bus->general_status==2)
                           echo '  <option value="1" >OK</option>
                           <option value="2" selected>Issue</option>
                           <option value="3">Void</option>
                           <option value="4">Refund</option>';
                           elseif ( $bus->general_status==3)
                           echo '  <option value="1" >OK</option>
                           <option value="2">Issue</option>
...
<input type="hidden" name="general_status" value="2">  ';
elseif ( $bus->general_status==3)
echo'<option value="3" disabled  selected>Void</option> 
<input type="hidden" name="general_status" value="3">';
else
echo '  <option value="4"  disabled selected>Refund</option>
<input type="hidden" name="general_status" value="4">
';
...
';
            ...
            if ($offered_status) {
              ...
              <div class="form-group" data-select2-id="44">
                  <select class="form-control select2 select2-hidden-accessible" name="offered_status"
                      id="code" style="width: 100%;" data-select2-id="2" tabindex="0"
                      aria-hidden="true">';
                      if( $bus->offered_status==1)
                      echo '  <option value="1" selected>OK</option>
                      <option value="2">Issue</option>
                      <option value="3">Void</option>
                      <option value="4">Refund</option>';
                      elseif ( $bus->offered_status==2)
                      echo '  <option value="1" >OK</option>
                      <option value="2" selected>Issue</option>
                      <option value="3">Void</option>
                      <option value="4">Refund</option>';
                      elseif ( $bus->offered_status==3)
                      echo '  <option value="1" >OK</option>
                      <option value="2">Issue</option>
                      <option value="3" selected>Void</option>
                      <option value="4">Refund</option>';
...
if( $bus->offered_status==1)
echo'<option value="2" selected disabled>OK</option>
<input type="hidden" name="offered_status" value="1">';
elseif ( $bus->offered_status==2)
echo '<option value="2" selected disbled>Issue</option>
<input type="hidden" name="offered_status" value="2">  ';
elseif ( $bus->offered_status==3)
echo'<option value="3" disabled  selected>Void</option> 
<input type="hidden" name="offered_status" value="3">';
else
echo '  <option value="4"  disabled selected>Refund</option>
<input type="hidden" name="offered_status" value="4">
';
...
?>
            <input required disabled  type="text"
              value="{{$bus->gen_info}}" class="form-control "  />
            <input required name="gen_info" style="width:100%" onkeyup="addHyphen(this)" id="tbNum" type="hidden"
              value="{{$bus->gen_info}}" class="form-control "  />
            <?php echo'   </div>
                </div>';
               }
...
';
      ...
      ?>
            ...
            @endforeach
            <div class="form-group">
              <a href="{{url('salesGenLog')}}" class="btn btn-outline-danger so_form_btn">Cancel</a>
