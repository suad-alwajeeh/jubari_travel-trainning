...
<div class="col-12">
  <ol class="breadcrumb float-sm-right bg-white">
    <li class="breadcrumb-bus"><a href="/salesBusLog">Bus Services</a></li>
    <li class="breadcrumb-bus active"> /Update Bus Services</li>
  </ol>
</div>
</br>
</br>
  ...
  <div class="container p-4">
    ...
    <div class="card card-outline card-info">
      ...
      <div class="card-body">
        ...
        <form method="POST" action="/service/updateBus2" enctype="multipart/form-data" id="signup-form">
          @csrf
                 ...
                 else
                 {
                   ...
                   <div class="form-group col-md-4 col-sm-12 col-xm-12">
                       ...
                       <div class="form-group">';
                         ...
                         ?> <input disabled required type="text" class="form-control " style="width:100%;"
              value="{{$bus->bus_name}}" />
            <input required type="hidden" class="form-control " style="width:100%;" name="bus_name"
              value="{{$bus->bus_name}}" />
...
?>
            <input disabled required type="number" class="form-control " style="width:100%;"
              value="{{$bus->bus_number}}" id="number" />
            <input required type="hidden" class="form-control " style="width:100%;" name="bus_number"
              value="{{$bus->bus_number}}" id="number" />
            <?php echo ' <small id="helpId2" class="text-muted "></small>
                     <a id="generate" class="btn btn-outline-primary so_form_btn"> Generate</a>
...
<input type="hidden" name="bus_status" value="1">';
elseif ( $bus->bus_status==2)
echo '<option value="2" selected disbled>Issue</option>
<input type="hidden" name="bus_status" value="2">  ';
elseif ( $bus->bus_status==3)
echo'<option value="3" disabled  selected>Void</option> 
<input type="hidden" name="bus_status" value="3">';
else
echo '  <option value="4"  disabled selected>Refund</option>
<input type="hidden" name="bus_status" value="4">
';
...
';
      ...
      ?>
            ...
            @endforeach
            <div class="form-group">
              <a href="{{url('salesBusLog')}}" class="btn btn-outline-danger so_form_btn">Cancel</a>
