...
<div class="col-12">
            <ol class="breadcrumb float-sm-right bg-white">
              <li class="breadcrumb-item"><a href="/service/show_car/1">Car Services</a></li>
    ...
    <div class="container p-4">
        ...
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="/service/updateCar" enctype="multipart/form-data" id="signup-form"
                    class="signup-form">
                    @csrf
                            ...
                            <div class="form-group col-md-6 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input required type="date" class="form-control " name="Issue_date"
                                        value="{{ \Carbon\Carbon::createFromDate($car->Issue_date)->format('Y-m-d')}}" />
                                </div>
                            </div>
                            <div class="form-group col-md-6 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" value="{{$car->refernce}}"
                                        name="refernce">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-md-6 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <input required type="text" class="form-control select2 select2-hidden-accessible"
                                        name="passenger_name" value="{{$car->passenger_name}}"
                            ...
                            <div class="form-group col-md-3 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="number" class="form-control " style="width:100%;"
                                        name="voucher_number" value="{{$car->voucher_number}}" id="number" />
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group" data-select2-id="44">
                                    ...
                                    <input required name="Dep_city1" style="width:100%" onkeyup="addHyphen(this)"
                                        id="tbNum" type="text" value="{{$car->Dep_city}}" class="form-control "
                                        list="cars" />
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group" data-select2-id="44">
                                    <input required type="date" style="width:100%"
                                        value="{{ \Carbon\Carbon::createFromDate($car->Dep_date)->format('Y-m-d')}}""
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                ...
                                <div class="form-group" data-select2-id="44">
                                    ...
                                    <input required type="text" class="form-control " style="width:100%;"
                                        name="car_info" value="{{$car->car_info}}" />
                                </div>
                            </div>
                            </div< <div class="around col-md-12 col-sm-12 col-xm-12 m-3">
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="form-group" data-select2-id="44">
                                        <select name="due_to_supp" required
                                            ...
                                            <option value="{{$car->s_no}}" selected>{{$car->supplier_name}}</option>
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="cur_id" required
                                            ...
                                            <option value="{{$car->cur_id}}" selected> {{$car->cur_name}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="form-group" data-select2-id="44">
                                        ...
                                        <select name="due_to_customer"
                                            ...
                                            @foreach($emp as $emps)
                                            @if($car->due_to_customer==$emps->emp_id)
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="form-group" data-select2-id="44">
                                        ...
                                        <select name="passnger_currency" class="form-control " style="width: 100%;"
                                            ...
                                            <option value="{{$car->passnger_currency}}" selected>
                                                {{$car->passnger_currency}}</option>
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xm-12">
                            ...
                            <div class="form-group" data-select2-id="44">
                                ...
                                <div class="images text-center mx-auto">
                                    @foreach(explode(',', $car->attachment) as $img)
            ...
            <div class="form-group">
                <a href="{{url('service/show_car/1')}}" class="btn btn-outline-danger so_form_btn">Cancel</a>
