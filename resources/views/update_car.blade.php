...
<form method="POST" action="/service/updateCar" enctype="multipart/form-data" id="signup-form" class="signup-form">
              @csrf
...
name="Issue_date" value="{{ \Carbon\Carbon::createFromDate($car->Issue_date)->format('Y-m-d')}}" />
                    </div>
                  </div>
                  <div class="form-group col-md-6 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group">
                      ...
                      <input required type="text" class="form-control" value="{{$car->refernce}}" name="refernce">
                    </div>
                  </div>
                </div>
                <div class="form-row col-md-12 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group col-md-3 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group">
                      ...
                      <input required type="number" class="form-control "
                        style="width:100%;" name="voucher_number" value="{{$car->voucher_number}}" id="number" />
                ...
                <div class="form-row col-md-12 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group col-md-4 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <input required name="Dep_city1" style="width:100%" onkeyup="addHyphen(this)" id="tbNum"
                        type="text" value="{{$car->Dep_city}}" class="form-control " list="cars" />
                  ...
                  <div class="form-group col-md-4 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      <input required type="date" style="width:100%" value="{{ \Carbon\Carbon::createFromDate($car->Dep_date)->format('Y-m-d')}}""
                  ...
                  <div class="form-group col-md-4 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <input required type="text" style="width:100%" name="arr_city" onkeyup="addHyphen(this)"
                        id="tbNum2" class="form-control " value="{{$car->arr_city}}" list="cars" />
                ...
                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <input required type="text" class="form-control "
                        style="width:100%;" name="car_info" value="{{$car->car_info}}" />
                    </div>
                  </div>
                </div<
                  ...
                  <div class="form-group col-md-12 col-sm-12 col-xm-12">
                    ...
                    <div class="form-group" data-select2-id="44">
                      ...
                      <select name="passnger_currency" class="form-control "
                        ...
                        <option value="{{$car->passnger_currency}}" selected>{{$car->passnger_currency}}</option>
              ...
              <div class="around">
                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group" data-select2-id="44">
                    ...
                    <textarea id="form7" class="md-textarea form-control" name="remark" rows="3">{{$car->remark}}</textarea>
                  </div>
                </div>
              </div>
              <div class="form-group col-md-12 col-sm-12 col-xm-12">
