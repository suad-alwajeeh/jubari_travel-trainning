  ...
  <div class="col-md-2">
    <div class="dropdown so_form_btn">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="/medicalReport">all</a>
        @foreach($all as $supp)
        <a class="dropdown-item" href="/medicalReport/a/{{$supp->s_no}}">{{$supp->supplier_name}}</a>
        @endforeach
      </div>
  ...
  <div class="col-md-2">
    <div class="dropdown so_form_btn">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="/medicalReport">all</a>
        @foreach($all as $supp)
        <a class="dropdown-item" href="/medicalReport/b/{{$supp->emp_id}}">{{$supp->emp_first_name}} {{$supp->emp_last_name}}</a>
        @endforeach
      </div>
...
<div class="container" id="pdf">  
  ...
  <table class="table table-hover text-center">
    ...
    <tbody>
      ...
      <tr>
        <input type="hidden" class="delete_id" value="{{$item->med_id}}">
        <td><?php echo $i;?></td>
