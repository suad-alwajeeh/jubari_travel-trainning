...
<div class="form-group col-md-4 col-sm-12">
      ...
      <input type="text" class="form-control" id="airline_code" maxlength="3" placeholder=" 123" name="airline_code">
    ...
    <div class="form-group col-md-4 col-sm-12">
      ...
      <input type="text" class="form-control" maxlength="2" id="carrier_code" placeholder=" carrier_code" name="carrier_code">
      <small id="helpId4" class="text-muted"></small>
</div>
    <div class="form-group col-md-4 col-sm-12">
      <label for="pwd">Code</label>
      <input type="text" class="form-control" id="code" maxlength="3" placeholder="code " name="code">
      <small id="helpId5" class="text-muted"></small>
</div>
    <div class="form-group col-md-4 col-sm-12">
      <label for="pwd">IATA</label>
      <input type="text" class="form-control" id="itat" placeholder="IATA" name="IATA">
      <small id="helpId6" class="text-muted"></small>
 </div>
    <div class="form-group col-md-12">
      <label for="pwd">	Remark</label>
      <textarea class="form-control" require name="remark" id="remark"></textarea>
...
<label class="checkbox-inline"><input type="checkbox" name="is_active" checked value="1">active</label>
   ...
   <input hidden="hidden" type="text" class="form-control" value="{{ Auth::user()->id }}" id="how_add_it" placeholder="how_add_it" name="how_add_it">
      ...
      if (itat != "" && remark != "" && airline_name != "" && carrier_code != "" && code != "" && carrier_code != ""){
         $.ajax({
             ...
             success:function(response){console.log(response);
              window.location.href = "/airline_display1/1";
                 },
