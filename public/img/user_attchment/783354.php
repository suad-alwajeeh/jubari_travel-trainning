...
//
 ...
 Route::group(['middleware' => ['auth','role:accountant']], function() {
  ...
  Route::get('/accountant_review/{id}/{s}','accountantController@accountant_review_with_status');
  ...
  Route::get('/accountant/accountant_finish_all/{user}','accountantController@accountant_finish_all');
...
Route::group(['middleware' => ['auth','role:sale_manager']], function() {
  ...
  Route::get('/displaySalesManager', 'BusServiceController@show_add_emp');
  Route::get('/displaySalesManager/TicketError', 'TicketServiceController@show_add_emp');
  Route::get('/displaySalesManager/HotelError', 'HotelServiceController@show_add_emp');
  Route::get('/displaySalesManager/CarError', 'CarServiceController@show_add_emp');
  Route::get('/displaySalesManager/MedError', 'MedicalServiceController@show_add_emp');
  Route::get('/displaySalesManager/GenError', 'GeneralServiceController@show_add_emp');
...
Route::post('/service/add_ticket/','TicketServiceController@add_ticket');
  ...
  Route::post('/service/updateTicket2','TicketServiceController@updateTicket2');
  Route::post('/service/updateBus','BusServiceController@updateBus');
  Route::post('/service/updateBus2','BusServiceController@updateBus2');
  Route::post('/service/updateCar','CarServiceController@updateCar');
  Route::post('/service/updateCar2','CarServiceController@updateCar2');
  Route::post('/service/updateHotel','HotelServiceController@updateHotel');
  Route::post('/service/updateHotel2','HotelServiceController@updateHotel2');
  Route::post('/service/updateVisa','VisaServiceController@updateVisa');
  Route::post('/service/updateVisa2','VisaServiceController@updateVisa2');
  Route::post('/service/updateMed','MedicalServiceController@updateMed');
  Route::post('/service/updateMed2','MedicalServiceController@updateMed2');
  Route::post('/service/updateGen','GeneralServiceController@updateGen');
  Route::post('/service/updateGen2','GeneralServiceController@updateGen2');
...
Route::get('/BusEmp','BusServiceController@show_add_emp');
Route::get('/service/generate_bus','BusServiceController@generate');
Route::get('/service/generate_car','CarServiceController@generate');
Route::get('/service/generate_hotel','HotelServiceController@generate');
Route::get('/service/generate_ticket','TicketServiceController@generate');
...
Route::get('/sales/up_err_gen/{id}','GeneralServiceController@update_Gen2');
Route::get('/sales/up_err_med/{id}','MedicalServiceController@update_Med2');
Route::get('/sales/up_err_ticket/{id}','TicketServiceController@update_Ticket2');
Route::get('/sales/up_err_hotel/{id}','HotelServiceController@update_hotel2');
